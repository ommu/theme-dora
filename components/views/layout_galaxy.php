 ...
 */
	...
	$cs->registerCssFile(Yii::app()->theme->baseUrl.'/css/galaxy/style.css');
	$cs->registerScriptFile(Yii::app()->theme->baseUrl.'/js/custom/galaxy.js', CClientScript::POS_END);
?>
